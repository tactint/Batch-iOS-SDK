...
#define JSON_PAYLOAD                                                                                                   \
    @"{\"notificationId\":\"a09c9800-7a3b-11ea-aaaa-29b797ebf207\",\"notificationTime\":1586420710448,\"sendId\":"     \
...
#pragma clang diagnostic pop
    ...
    if (sqlite3_prepare_v2(self->_database, [selectQuery cStringUsingEncoding:NSUTF8StringEncoding], -1,
        ...
        while (sqlite3_step(selectStatement) == SQLITE_ROW) {
            ...
            // Identifier
            XCTAssertEqualObjects(@"test-custom-id", [NSString stringWithUTF8String:(const char *)sqlite3_column_text(
                                                                                        selectStatement, 2)]);
        }
    ...
    long long fetcherId2 = [_datasource createFetcherIdWith:BAInboxWebserviceClientTypeInstallation
                                                 identifier:@"test-install-id"];
    ...
    if (sqlite3_prepare_v2(self->_database, [selectQuery cStringUsingEncoding:NSUTF8StringEncoding], -1,
        ...
        while (sqlite3_step(selectStatement) == SQLITE_ROW) {
            ...
            // Identifier
            XCTAssertEqualObjects(@"test-install-id", [NSString stringWithUTF8String:(const char *)sqlite3_column_text(
                                                                                         selectStatement, 2)]);
        }
    ...
    long long fetcherId3 = [_datasource createFetcherIdWith:BAInboxWebserviceClientTypeUserIdentifier
                                                 identifier:@"test-custom-id"];
...
- (void)testSimpleInsert {
    ...
    if (sqlite3_prepare_v2(self->_database, [selectQuery cStringUsingEncoding:NSUTF8StringEncoding], -1,
        ...
        while (sqlite3_step(selectStatement) == SQLITE_ROW) {
            ...
            XCTAssertEqualObjects(
                @"test-id", [NSString stringWithUTF8String:(const char *)sqlite3_column_text(selectStatement, 1)]);
            XCTAssertEqualObjects(
                @"test-send-id", [NSString stringWithUTF8String:(const char *)sqlite3_column_text(selectStatement, 2)]);
            ...
            XCTAssertEqualObjects(
                PUSH_PAYLOAD, [NSString stringWithUTF8String:(const char *)sqlite3_column_text(selectStatement, 6)]);
        }
    ...
    if (sqlite3_prepare_v2(self->_database, [selectQuery cStringUsingEncoding:NSUTF8StringEncoding], -1,
        ...
        while (sqlite3_step(selectStatement) == SQLITE_ROW) {
            ...
            // notification_id
            XCTAssertEqualObjects(
                @"test-id", [NSString stringWithUTF8String:(const char *)sqlite3_column_text(selectStatement, 2)]);
            // install_id
            XCTAssertEqualObjects(@"test-install-id", [NSString stringWithUTF8String:(const char *)sqlite3_column_text(
                                                                                         selectStatement, 3)]);
            // custom_id
...
- (void)testCleanDatabase {
    ...
    if (sqlite3_prepare_v2(self->_database, [selectQuery cStringUsingEncoding:NSUTF8StringEncoding], -1,
        ...
        while (sqlite3_step(selectStatement) == SQLITE_ROW) {
            ...
            if (count == 1) {
                XCTAssertEqualObjects(@"test-id-1", [NSString stringWithUTF8String:(const char *)sqlite3_column_text(
                                                                                       selectStatement, 1)]);
                XCTAssertEqual(times[1], sqlite3_column_int64(selectStatement, 5));
            } else if (count == 2) {
                XCTAssertEqualObjects(@"test-id-3", [NSString stringWithUTF8String:(const char *)sqlite3_column_text(
                                                                                       selectStatement, 1)]);
...
- (void)testCandidateNotification {
    ...
    NSArray<BAInboxCandidateNotification *> *candidates = [_datasource candidateNotificationsFromCursor:@"test-id-3"
                                                                                                  limit:3
                                                                                              fetcherId:fetcherId];
...
- (void)testCandidateNotificationMutipleFecther {
    long long customFetcherId = [_datasource createFetcherIdWith:BAInboxWebserviceClientTypeUserIdentifier
                                                      identifier:@"test-custom-id"];
    XCTAssertTrue(customFetcherId > 0);

    long long installFetcherId = [_datasource createFetcherIdWith:BAInboxWebserviceClientTypeUserIdentifier
                                                       identifier:@"test-install-id"];
    ...
    NSArray<BAInboxCandidateNotification *> *candidates =
        [_datasource candidateNotificationsFromCursor:@"test-id-0" limit:10 fetcherId:customFetcherId];
    XCTAssertEqual(3, [candidates count]);
...
- (void)testUpdate {
    ...
    updatePayload = [BAJson
        deserializeAsDictionary:@"{\"notificationId\":\"test-id\",\"notificationTime\":123456000,\"sendId\":\"updated-"
                                @"send-id\",\"installId\":\"updated-install-id\",\"customId\":\"updated-custom-id\"}"
                          error:nil];
    XCTAssertEqualObjects(@"test-id", [_datasource updateNotification:updatePayload withFetcherId:fetcherId]);
    ...
    if (sqlite3_prepare_v2(self->_database, [selectQuery cStringUsingEncoding:NSUTF8StringEncoding], -1,
        ...
        while (sqlite3_step(selectStatement) == SQLITE_ROW) {
            ...
            XCTAssertEqualObjects(
                @"test-id", [NSString stringWithUTF8String:(const char *)sqlite3_column_text(selectStatement, 1)]);
            XCTAssertEqualObjects(@"updated-send-id", [NSString stringWithUTF8String:(const char *)sqlite3_column_text(
                                                                                         selectStatement, 2)]);
            XCTAssertEqual(0, sqlite3_column_int(selectStatement, 3));
            XCTAssertEqual(0, sqlite3_column_int(selectStatement, 4));
    ...
    if (sqlite3_prepare_v2(self->_database, [selectQuery cStringUsingEncoding:NSUTF8StringEncoding], -1,
        ...
        while (sqlite3_step(selectStatement) == SQLITE_ROW) {
            ...
            XCTAssertEqualObjects(
                @"updated-custom-id",
                [NSString stringWithUTF8String:(const char *)sqlite3_column_text(selectStatement, 4)]);
        }
