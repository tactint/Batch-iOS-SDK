...
- (void)registerInjectable:(nonnull BAInjectable *)injectable
               forProtocol:(nonnull Protocol *)protocol NS_SWIFT_NAME(register(injectable:forProtocol:));

- (void)registerInjectable:(nonnull BAInjectable *)injectable
                  forClass:(nonnull Class)classToRegister NS_SWIFT_NAME(register(injectable:forClass:));
