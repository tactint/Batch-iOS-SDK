...
- (NSData *)encryptAES:(NSData *)data usingKey:(NSString *)key {
    ...
    [key getCString:keyPtr
          maxLength:sizeof(keyPtr)
           encoding:NSUTF8StringEncoding]; // Change from NSUTF16StringEncoding to NSUTF8StringEncoding
    ...
    CCCryptorStatus result = CCCrypt(kCCEncrypt, kCCAlgorithmAES128, kCCOptionPKCS7Padding | kCCOptionECBMode, keyPtr,
                                     kCCKeySizeAES128, // Changed from 256 to 128
                                     NULL, [data bytes], [data length], buffer, bufferSize, &numBytesEncrypted);
...
- (NSData *)decryptAES:(NSData *)data usingKey:(NSString *)key {
    ...
    CCCryptorStatus result = CCCrypt(kCCDecrypt, kCCAlgorithmAES128, kCCOptionPKCS7Padding | kCCOptionECBMode, keyPtr,
                                     kCCBlockSizeAES128, // Changed from 256 to 128
                                     NULL, [data bytes], [data length], buffer_decrypt, bufferSize, &numBytesEncrypted);
