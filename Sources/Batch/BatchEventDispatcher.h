...
///
/// Only used for messages of type `BatchEventDispatcherTypeMessagingWebViewClick`  and
/// `BatchEventDispatcherTypeMessagingClose`. Matches the `analyticsID` parameter of various methods of the
/// JavaScript SDK.
...
/// Called when a new event happens in the Batch
///
/// - Parameters:
...
/// - Returns:True if the event is associated with a push notification, false otherwise
...
/// - Parameters:
///   - eventType: The type of the event.
/// - Returns:True if the event is associated with an in-app or landing message, false otherwise.
