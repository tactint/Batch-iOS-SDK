...
- (void)fetchIdentifiers {
    ...
    [temporaryIdentifiers
        addObject:[BADBGNameValueListItem itemWithName:@"Batch SDK"
                                                 value:[@"Version " stringByAppendingString:BACoreCenter.sdkVersion]]];
    [temporaryIdentifiers addObject:[BADBGNameValueListItem itemWithName:@"Installation ID"
                                                                   value:[BatchUser installationID]]];
    [temporaryIdentifiers addObject:[BADBGNameValueListItem itemWithName:@"Push Token"
                                                                   value:(pushToken != nil ? pushToken : @"none")]];
    [temporaryIdentifiers
        addObject:[BADBGNameValueListItem itemWithName:@"APNS Environment"
                                                 value:([BABundleInfo usesAPNSandbox] ? @"Sandbox" : @"Production")]];
