...
- (void)setCampaign:(BALocalCampaign *)campaign {
    ...
    [items addObject:[BADBGNameValueListItem itemWithName:@"Start Date"
                                                    value:[self nullableDateString:campaign.startDate]]];
    [items addObject:[BADBGNameValueListItem itemWithName:@"End Date"
                                                    value:[self nullableDateString:campaign.endDate]]];
    [items addObject:[BADBGNameValueListItem
                         itemWithName:@"Capping"
                                value:(campaign.capping > 0 ? [@(campaign.capping) stringValue] : @"None")]];
    [items addObject:[BADBGNameValueListItem
                         itemWithName:@"Grace period"
                                value:(campaign.minimumDisplayInterval > 60
                                           ? [@(campaign.minimumDisplayInterval) stringValue]
                                           : @"None")]]; // Hide any grace period that's not more than one minute
