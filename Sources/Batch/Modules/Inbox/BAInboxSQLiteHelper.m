...
- (BOOL)bindNotification:(BAInboxNotificationContent *)notification withStatement:(sqlite3_stmt **)statement {
    ...
    sqlite3_bind_text(*statement, 1, [notification.identifiers.identifier cStringUsingEncoding:NSUTF8StringEncoding],
                      -1, NULL);
    sqlite3_bind_text(*statement, 2, [notification.identifiers.sendID cStringUsingEncoding:NSUTF8StringEncoding], -1,
                      NULL);
...
- (BOOL)bindFetcherNotification:(BAInboxNotificationContent *)notification
    ...
    sqlite3_bind_text(*statement, 2, [notification.identifiers.identifier cStringUsingEncoding:NSUTF8StringEncoding],
                      -1, NULL);
